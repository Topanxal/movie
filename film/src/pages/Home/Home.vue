<template>
  <div id="home">
    ...
    <div class="main">
      ...
      <div class="panel">
        <div class="header">
          <span class="black-name">猜你想看</span>
          <span
            class="more"
            @click="$router.push({ path: '/movie', query: { hotMovie: 2 } })"
            >全部{{ recommendedMovieList.length }}部
        ...
        <div class="body">
          <div
            class="item"
            v-for="(item, index) in recommendedMovieList.slice(0, 6)"
            :key="index"
          >
            <img
              :src="server + item.poster"
